...
| `nodeAnalyzer.hostScanner.image.tag`                                 | The image tag to pull the Host Scanner                                                     | `0.3.4`                                                                                                                                                               |
...
| `nodeAnalyzer.imageAnalyzer.image.tag`                               | The image tag to pull the Node Image Analyzer                                              | `0.1.22`                                                                                                                                                              |
...
| `nodeAnalyzer.runtimeScanner.image.tag`                              | The image tag to pull the Runtime Scanner                                                  | `1.4.4`                                                                                                                                                               |
