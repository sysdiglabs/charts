...
| `nodeAnalyzer.hostScanner.image.tag`                                 | The image tag to pull the Host Scanner                                                   | `0.3.10`                                                                                                                                                               |
...
| `nodeAnalyzer.kspmAnalyzer.image.tag`                                | The image tag to pull the  KSPM node analyzer                                            | `1.23.0`                                                                                                                                                              |
