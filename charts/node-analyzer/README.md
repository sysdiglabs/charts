...
| `nodeAnalyzer.hostAnalyzer.image.tag`                                | The image tag to pull the Host Analyzer                                                  | `0.1.13`                                                                       |
...
| `nodeAnalyzer.kspmAnalyzer.image.tag`                                | The image tag to pull the  KSPM node analyzer                                            | `1.14.0`                                                                       |
...
| `nodeAnalyzer.kspmAnalyzer.probes.initialDelay`                      | KSPM node analyzer initial delay before starting k8s health checks in seconds            | `90`                                                                            |
