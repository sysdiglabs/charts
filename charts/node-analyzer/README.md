...
| `nodeAnalyzer.hostScanner.image.tag`                                 | The image tag to pull the Host Scanner                                                   | `0.3.8`                                                                                                                                                               |
...
| `nodeAnalyzer.runtimeScanner.image.tag`                              | The image tag to pull the Runtime Scanner                                                | `1.4.8`                                                                                                                                                               |
