{{- define "common.regions" -}}
  {{- $regions := dict "au1" (dict "collector_endpoint"  "ingest.au1.sysdig.com"
                      ...
                      "in-mum-monitor"   (dict "collector_endpoint"  "ingest.in-mum.monitoring.cloud.ibm.com"
                      ...
                      "in-mum-private-monitor"   (dict "collector_endpoint"  "ingest.private.in-mum.monitoring.cloud.ibm.com"
                                                       "monitor_api_endpoint" "private.in-mum.monitoring.cloud.ibm.com"
                                                       "secure_api_endpoint"  "private.in-mum.security-compliance-secure.cloud.ibm.com"
                                                       "secure_ui"           "private.in-mum.security-compliance-secure.cloud.ibm.com")
                      ...
                      "in-che-secure"   (dict "collector_endpoint"  "ingest.in-che.security-compliance-secure.cloud.ibm.com"
                                              ...
                                              "secure_api_endpoint"  "in-che.security-compliance-secure.cloud.ibm.com"
                                              "secure_ui"           "in-che.security-compliance-secure.cloud.ibm.com")
                      "in-mum-secure"   (dict "collector_endpoint"  "ingest.in-mum.security-compliance-secure.cloud.ibm.com"
                                              "monitor_api_endpoint" "in-mum.monitoring.cloud.ibm.com"
                                              "secure_api_endpoint"  "in-mum.security-compliance-secure.cloud.ibm.com"
                                              "secure_ui"           "in-mum.security-compliance-secure.cloud.ibm.com")
                      ...
                      "in-che-private-secure"   (dict "collector_endpoint"  "ingest.private.in-che.security-compliance-secure.cloud.ibm.com"
                                                      ...
                                                      "secure_api_endpoint"  "private.in-che.security-compliance-secure.cloud.ibm.com"
                                                      "secure_ui"           "private.in-che.security-compliance-secure.cloud.ibm.com")
                      "in-mum-private-secure"   (dict "collector_endpoint"  "ingest.private.in-mum.security-compliance-secure.cloud.ibm.com"
                                                      "monitor_api_endpoint" "private.in-mum.monitoring.cloud.ibm.com"
                                                      "secure_api_endpoint"  "private.in-mum.security-compliance-secure.cloud.ibm.com"
                                                      "secure_ui"           "private.in-mum.security-compliance-secure.cloud.ibm.com")
