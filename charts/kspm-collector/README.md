...
| `image.tag`                                | Specifies the image tag to pull from the image repository.                                                                                       | `1.33.0`                                                    |
...
| `natsMaxReconnect`                         | Sets `natsMaxReconnect ` configuration variables. Set to '-1' for unlimited reconnect attempts to NATS, or leave empty for default (60 attempts).| `""`                                                        |
