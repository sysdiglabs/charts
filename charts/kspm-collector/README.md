...
| `image.tag`                                | Specifies the image tag to pull from the image repository.                                                                                        | `1.38.1`                                                    |
...
| `natsMaxReconnectFailures`                 | Sets `natsMaxReconnectFailures ` configuration variables. Set to '-1' to disable or leave empty for default (60 attempts).                        | `0`                                                         |
