...
| config.scan.inlineJobNodeSelector              | NodeSelector for child pods, if both .Values.nodeSelector and this field are present, this one takes precedence. scanning                                                                                                                                                   | <code>{}</code>                           |
