...
|------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| cronjob.schedule                   | Cronjob expression for registry scan scheduling.                                                                                                                                                                             | <code>"0 6 * * *"</code>                                            |
...
| config.scan.newVmScanner           | capabilities: drop: - ALL readOnlyRootFilesystem: true runAsNonRoot: true runAsUser: 1000 true/false whether to activate the beta image scanning (experimental and unsupported)                                              | <code>false</code>                                                  |
