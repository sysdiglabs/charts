...
| config.filter.maxAgeDays                         | Based on its creation date, excludes images older than specified number of days.<br/>Maximum 365                                                                                                                                            | <code>365</code>                             |
| config.filter.maxTagsPerRepository               | Based on its creation date, newer ones take precedence, maximum number of tags to scan per repository.<br/>Maximum 10                                                                                                                       | <code>50</code>                              |
| config.filter.maxRepositoriesPerRegistry         | Number of repositories to scan per registry.<br/>Maximum Value 1000                                                                                                                                                                         | <code>10000</code>                           |
