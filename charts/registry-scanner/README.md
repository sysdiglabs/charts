...
| config.scan.jobs.requestMemory           | Resouce request memory for scanner job                                                                                                                                                                                                      | <code>500Mi</code>                           |
| config.scan.jobs.requestCpu              | Resource request CPU for scanner job                                                                                                                                                                                                        | <code>500m</code>                            |
| config.scan.jobs.limitMemory             | Resource limit memory for scanner job                                                                                                                                                                                                       | <code>2Gi</code>                             |
