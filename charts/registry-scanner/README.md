...
```bash
$ helm install registry-scanner -f values.yaml --version=1.0.9 sysdig/registry-scanner
```
...
| config.scan.jobs.ttlSecondsAfterFinished         | ttl for scanner worker jobs. unset with empty value                                                                                                                                                                                         | <code>600</code>                             |
