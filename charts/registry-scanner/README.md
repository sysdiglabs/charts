...
| config.aws.allowListRegions                      | Organization regions where to perform the registry scan. If not configured, the scan will be performed in all available regions.                                                                                                            | <code>[]</code>                              |
