...
| config.registryType                              | Mandatory.<br/>The registry Type. Supported types: artifactory, ecr, icr, acr, quay, harbor, gar, gcr, nexus, cloudsmith and dockerv2.                                                                                                     | <code>""</code>                              |
...
| config.gar.regions                               | List of Google Artifact Registry regions where registries are located.                                                                                                                                                                     | <code>[]</code>                              |
