...
| onPremCompatibilityVersion                        | Optional parameter used to check the compatibility of cluster-scanner component versions with respect to the onprem backend version. E.g. if `onPremCompatibilityVersion=6.2`, then we make sure that the image tag is < 1.0.0 for both the Runtime Status Integrator and the Image SBOM Extractor.         | <code>"6.2"</code>                            |
...
| runtimeStatusIntegrator.image.tag                 |                                                                                                                                                                                                                                                                                                             | <code>"0.4.0"</code>                          |
...
| runtimeStatusIntegrator.ports.pprof               | The port to be used for pprof by the Runtime Status Integrator. You must explicitly enable pprof with the `pprofEnabled` flag.                                                                                                                                                                              | <code>6060</code>                             |
...
| runtimeStatusIntegrator.pprofEnabled              | Set to `true` to enable the `pprof` profiler for the Runtime Status Integrator. Used for debugging purposes. **DO NOT SET** to `true` in production.                                                                                                                                                        | <code>false</code>                            |
...
| imageSbomExtractor.image.tag                      |                                                                                                                                                                                                                                                                                                             | <code>"0.4.0"</code>                          |
...
| imageSbomExtractor.ports.pprof                    | The port to be used for pprof by the Image SBOM Extractor. You must explicitly enable pprof with the `pprofEnabled` flag.                                                                                                                                                                                   | <code>6061</code>                             |
...
| imageSbomExtractor.pprofEnabled                   | Set to `true` to enable the `pprof` profiler for the Image Sbom Extractor. Used for debugging purposes. **DO NOT SET** to `true` in production.                                                                                                                                                             | <code>false</code>                            |
| imageSbomExtractor.cache.type                     | The type of cache to use. Allowed values are `local`, `distributed` and `local,distributed`. When specified both, the former will take precedence and the latter will be used as fallback. When setting `distributed`, you should also setup redis settings below accordingly with your redis installation. | <code>"local"</code>                          |
