...
| runtimeStatusIntegrator.image.tag                 |                                                                                                                                                                                                                                                                                                     | <code>"0.3.3"</code>                          |
...
| imageSbomExtractor.image.tag                      |                                                                                                                                                                                                                                                                                                     | <code>"0.3.3"</code>                          |
...
| imageSbomExtractor.cache.type                     | The type of cache to use, either `local` or `redis`. When setting `redis`, both Redis and the local cache will be used.                                                                                                                                                                             | <code>"local"</code>                          |
