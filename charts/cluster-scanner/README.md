...
| runtimeStatusIntegrator.image.tag                 |                                                                                                                                                                                                                                                                                                                                                                                                            | <code>"0.4.1"</code>                          |
...
| imageSbomExtractor.image.tag                      |                                                                                                                                                                                                                                                                                                                                                                                                            | <code>"0.4.1"</code>                          |
...
| imageSbomExtractor.cache.local.lruMaxElementSize  | When using `local[lru]` as cache type, restrict the maximum size of elements to be cached. By default it is set to 100KB                                                                                                                                                                                                                                                                                   | <code>"102400"</code>                         |
