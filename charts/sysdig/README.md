...
| `image.tag`                                                          | The image tag to pull                                                                    | `12.9.0`                                                                       |
...
| `kspm.deploy`                                                        | Enables Sysdig KSPM node analyzer & KSPM collector                                       | `true`                                                                          |
...
| `nodeAnalyzer.benchmarkRunner.image.tag`                             | The image tag to pull the Benchmark Runner                                               | `1.1.0.1`                                                                      |
