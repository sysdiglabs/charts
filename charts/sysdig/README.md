...
| `image.tag`                                                          | The image tag to pull                                                                    | `12.3.0`                                                                       |
...
| `nodeAnalyzer.runtimeScanner.deploy`                                 | Deploy the Runtime Scanner                                                               | `sysdig/eveclient-api`                                                         |
...
| `nodeAnalyzer.runtimeScanner.resources.requests.memory`              | Runtime Scanner Memory requests per node                                                 | `4096Mi`                                                                       |
...
| `nodeAnalyzer.runtimeScanner.resources.limits.memory`                | Runtime Scanner Memory limit per node                                                    | `6144Mi`                                                                       |
