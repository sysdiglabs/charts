...
| `nodeAnalyzer.runtimeScanner.storageClass`                           | Storage class to use for runtime scanner tmp-vol                                         | `10Gi `                                                                        |
| `nodeAnalyzer.runtimeScanner.storageClassVolumeSize`                 | Storage class Volume Size (only used if above storageClass is set)                       | `false`                                                                        |
