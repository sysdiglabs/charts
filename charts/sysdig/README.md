...
| `nodeAnalyzer.imageAnalyzer.settings.dockerSocketPath`     | The Docker socket path                                                                   |                                                                               |
| `nodeAnalyzer.imageAnalyzer.settings.criSocketPath`        | The socket path to a CRI compatible runtime, such as CRI-O                               |                                                                               |
| `nodeAnalyzer.imageAnalyzer.settings.containerdSocketPath` | The socket path to a CRI-Containerd daemon                                               |                                                                               |
...
| `nodeAnalyzer.hostAnalyzer.settings.maxSendAttempts`       | The number of times the analysis collector is allowed to retry sending results           | `3`                                                                           |
