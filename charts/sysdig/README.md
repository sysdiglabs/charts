...
| `nodeAnalyzer.cspmAnalyzer.image.tag`                                | The image tag to pull the  CSPM node analyzer                                            | `1.1.1`                                                                        |
...
| `cspmCollector.image.tag`                                            | The image tag to pull the  CSPM collector                                                | `1.1.1`                                                                        |
