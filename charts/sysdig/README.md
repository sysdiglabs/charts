...
| `image.tag`                                                          | The image tag to pull                                                                    | `12.8.0`                                                                       |
...
| `nodeAnalyzer.storageClass`                                          | Storage class to use for tmp-vol                                                         | ` `                                                                            |
| `nodeAnalyzer.storageClassVolumeSize`                                | Storage class Volume Size (only used if above storageClass is set)                       | `10Gi`                                                                         |
