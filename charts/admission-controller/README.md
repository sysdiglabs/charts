...
| webhook.ssl.ca.cert                 | A PEM-encoded x509 certificate authority to use in the certificate generation and to contact the Secure backend. If empty, a new CA will be autogenerated.                                                                                                                                             | `""`                                                                                                                                                                                    |
...
| scanner.ssl.ca.cert                 | A PEM-encoded x509 certificate authority to use when contacting the secure backend.                                                                                                                                                                                                                    | `""`                                                                                                                                                                                    |
