...
|----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| global.clusterConfig.name                          | Set a cluster name to identify events using *kubernetes.cluster.name* tag                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>""</code>                                                                                                                                                                                    |
| global.sysdig.secureAPIToken                       | API Token to access Sysdig Secure. <br/><br/>If neither this value nor `global.sysdig.existingSecureAPITokenSecret` are configured, the user will be required to provide the deployment the `SECURE_API_TOKEN` (and `AUTH_BEARER_TOKEN` if the scanner is enabled) environment variables.                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | <code>""</code>                                                                                                                                                                                    |
| global.sysdig.secureAPITokenSecret                 | Existing secret with API Token to access Sysdig Secure <br/>Alternatively, specify the name of a Kubernetes secret containing `SECURE_API_TOKEN` and `AUTH_BEARER_TOKEN` entry if you're also enabling scanner. <br/><br/>If neither this value nor `global.sysdig.secureAPIToken` are configured, the user will be required to provide the deployment the `SECURE_API_TOKEN` (and `AUTH_BEARER_TOKEN` if the scanner is enabled) environment variables.                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>""</code>                                                                                                                                                                                    |
| global.proxy.httpProxy                             | Sets `HTTP_PROXY` on the Admission Controller containers                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>""</code>                                                                                                                                                                                    |
| global.proxy.httpsProxy                            | Sets `HTTPS_PROXY` on the Admission Controller containers                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | <code>""</code>                                                                                                                                                                                    |
| global.proxy.noProxy                               | Sets `NO_PROXY` on the Admission Controller containers                                                                             | <code>""</                                                       |
| clusterName                                        | Set a cluster name to identify events using *kubernetes.cluster.name* tag. Overrides `global.clusterConfig.name`                                                                                                                                                                                                                                                                                                                                                                                                            | <code>""</code>                                                                                                                                                                                    |
