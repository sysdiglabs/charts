...
|----------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------|
| global.clusterConfig.name                          | Global cluster Name which appear on Secure UI                                                                                                                                                                                                                                                                                                                                                                                                                       | <code>""</code>                          |
...
| webhook.resources.limits.cpu                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>250m</code>                        |
| webhook.resources.limits.memory                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>256Mi</code>                       |
| webhook.resources.requests.cpu                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>100m</code>                        |
| webhook.resources.requests.memory                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>256Mi</code>                       |
...
| scanner.podAnnotations.prometheus.io/scrape        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>"true"</code>                      |
| scanner.podAnnotations.prometheus.io/path          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>"/metrics"</code>                  |
| scanner.podAnnotations.prometheus.io/port          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>"8080"</code>                      |
...
| scanner.securityContext.readOnlyRootFilesystem     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>true</code>                        |
| scanner.securityContext.runAsNonRoot               |                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | <code>true</code>                        |
