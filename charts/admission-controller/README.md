...
$ helm upgrade --install sysdig-admission-controller sysdig/admission-controller \
      --create-namespace -n sysdig-admission-controller --version=0.6.9  \
...
```console
$ helm upgrade --install sysdig-admission-controller sysdig/admission-controller -n sysdig-admission-controller --version=0.6.9
```
...
| scanner.enabled                                    | If you only want the Kuberentes Audit Log functionality then disable this and it will disable the Admission Controller Scanning Policy functionality.                                                                                                                                                                                                                                                                                                                                                                                                                                          | <code>true</code>                                                                                                                                                                                  |
